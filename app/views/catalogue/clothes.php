<?php
// т.к. верстка одинакова в компьютерах и одежде то рациональнее верстку разместить в новом файле, который затем подключать в одноименных файлах сохраняя принцып DRY
